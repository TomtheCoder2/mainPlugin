...
public class Rank {
    ...
    public static final Rank[] all = new Rank[]{
            new Rank(null, "Civilian", new Color(0x7ab7cbff), "New combatants", "None"),     // 0
            new Rank("\uE865", "Soldier", new Color(0x7ac3cbff)),  // 1
            new Rank("\uE861", "Corporal", new Color(0x7acbc6ff)), // 2
            new Rank("\uE804", "Brigadier", new Color(0x7acbb8ff)),// 3
            new Rank("\uE826", "Sargeant", new Color(0x7acba1ff)), // 4
            new Rank("\uE806", "Major", new Color(0x7acb8fff)),    // 5
            new Rank("\uE810", "Lieutenant", new Color(0x80cb7aff), "", "Be decorated by General/Marshal"),     // 6
            new Rank("\uE811", "Captain", new Color(0x97cb7aff), "Map creator / coder", "Create maps or code for the server"), // 7
            new Rank("\uE808", "Map Reviewer", new Color(0xb5cb7aff), "", "Apply on Discord"),  // 8
            new Rank("\uE864", "Colonel", new Color(0xcbc47aff), "Junior Moderator", "Apply on Discord"),  // 9
            new Rank("\uE817", "General", new Color(0xcbb07aff), "Moderator", "Be decorated from Colonel"),          // 10
